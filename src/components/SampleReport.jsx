      ...
      <div className="content-container relative z-10">
        ...
        >
          ...
          <motion.h2 variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.1 } } }} className="font-serif text-3xl sm:text-4xl lg:text-5xl mt-4 text-balance text-charcoal">
            A report built to be shared, reviewed, and defended.
          </motion.h2>
          <motion.p
          ...
          >
            Review the kind of report a user can download, share, and use to support a verification decision.
          </motion.p>
        </motion.div>

        <InteractivePanel className="mx-auto max-w-6xl rounded-[2rem] border border-stone-light/80 bg-white-warm/88 shadow-[0_32px_90px_rgba(26,26,26,0.12)] backdrop-blur-xl">
          <motion.div
